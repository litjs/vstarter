...
_gulp2.default.task('build', _gulp2.default.series(_gulp2.default.parallel('clean', 'webpack'), function (cb) {
  cb();
}));

_gulp2.default.task('default', _gulp2.default.series('clean', _gulp2.default.parallel('webpack', 'connect'), function (cb) {
  cb();
}));